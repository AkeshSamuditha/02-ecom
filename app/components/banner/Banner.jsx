  ...
  return (
    <main className=" flex justify-between items-center py-1 mb-5  relative">
      <section className="max-w-xl mx-auto sm:mx-0  w-full py-2  lg:w-1/3">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-left text-gray-800 py-3 w-full">
          <span className="block text-pink-600">Discover</span>
          <span className="block text-purple-800">Unmatched</span>
          <span className="block text-blue-900">Elegance</span>
        </h1>
